...
export default function Flights() {
  ...
  const resetFilters = () => {
    setStopsFilter([])
    setAirlines(['IndiGo', 'Air India', 'Vistara', 'SpiceJet'])
    setMaxPrice(18500)
    setActiveSlots([])
    setSortKey('price')
  }
  ...
  const displayDate = dateParam
    ? new Date(dateParam).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })
    : 'Select Date'
  ...
  const handleBookNow = () => {
    ...
    addItem({
      ...
      details: {
        ...
        date: displayDate,
        // Use regex to extract the leading digit to avoid fragile parseInt hack
      ...
      <div className={styles.layout}>
        ...
        <main className={styles.results}>
          <div className={styles.remoteBanner}>
            ...
            <Link to="/explore" className={styles.remoteBannerLink}>Explore remote flights →</Link>
          </div>
